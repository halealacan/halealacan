    ...
    <div className="login-card">
      ...
      <div className="mb-6">
        ...
        <div className="role-selector-grid">
          <div>
            <input type="radio" id="role-admin" name="user-role-select" defaultChecked className="role-input" />
          ...
          <div>
            <input type="radio" id="role-accounting" name="user-role-select" className="role-input" />
          ...
          <div>
            <input type="radio" id="role-technical" name="user-role-select" className="role-input" />
      ...
      <form onSubmit={(e) => e.preventDefault()}>
        <div className="form-group">
          ...
          <input type="email" id="email" className="form-input" placeholder="ornek@sirket.com" defaultValue="selahaddin@sirket.com" required />
        </div>

        <div className="form-group">
          <label htmlFor="pass" className="form-label">Şifre</label>
          <input type="password" id="pass" className="form-input" placeholder="••••••••" defaultValue="123456" required />
        </div>
        ...
        <label htmlFor="tab-dashboard" className="login-submit-btn">
          Sisteme Giriş Yap
        </label>
      </form>
