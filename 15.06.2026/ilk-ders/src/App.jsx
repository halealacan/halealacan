...
function App() {
  ...
  <div className='p-4 md:p-6 bg-gray-100 min-h-screen'>
    <div className='border border-gray-200 rounded-2xl bg-white overflow-hidden shadow-lg'>
      <div className='p-5 bg-linear-to-r from-blue-600 to-indigo-700 flex flex-col sm:flex-row justify-betweem items-center gap-2'></div>
        <div>
          <h1 className='text-white text-x font-bold'>react state & form yönetim paneli</h1>
        </div>

        <div>
          <div className='grid grid-cols-1 md:grid-cols-4 min-h-\[600px]'>
            <div className='border-r' border-gray-200 bg-gray-200 bg-gray-50>
